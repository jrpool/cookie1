...
The application fulfills the requirements of the App1 component of the Secure Session Cookie exercise in the “Adding State to HTTP” module in Phase 2 of the [Learners Guild][lg] curriculum.
...
2. Clone this project’s repository into it, thereby creating the project directory, named `app1`, by executing:

    `git clone https://github.com/jrpool/cookie1.git app1`
